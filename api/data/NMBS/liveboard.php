...
class Liveboard
{
    ...
    public static function fillDataRoot($dataroot, $request)
    {
        ...
        if (strtoupper(substr($request->getArrdep(), 0, 1)) == "A") {
            ...
            $dataroot->arrival = liveboard::parseData(
                $html, $request->getTime(),
                $request->getLang(),
                $request->isFast()
            );
            ...
            $dataroot->departure = liveboard::parseData(
                $html, $request->getTime(),
                $request->getLang(),
                $request->isFast()
            );
     ...
     * @param  <type> $timeSel <description>
     * @return string
     */
