...
class Stations
{
    ...
    public static function getStationFromLocation($locationX, $locationY, $lang){
        ...
        try {
            ...
            $result = mysql_query($query) || throw new Exception("Could not get station from coordinates from DB");
    ...
    public static function getStationFromName($name, $lang){
        ...
        $post = http_get($url) || throw new Exception("iRail down");
    ...
    private static function fetchAllStationsFromDB($lang){
        ...
        try {
            ...
            $result = mysql_query($query) || throw new Exception("Could not get stationslist from DB");
            $i = 0;
