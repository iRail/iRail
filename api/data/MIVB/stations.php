...
class Stations
{
    ...
    public static function getStationFromLocation($locationX, $locationY, $lang)
    {
        ...
        try {
            ...
            // It selects the closest station to the given coordinates.
            // It needs to calculate the squared distance and return the smalest of those
    ...
    public static function getStationFromName($name, $lang)
    {
        ...
        try {
            ...
            $query = "
                SELECT `ID`,`X`, `Y`, `STD`,`$lang`
                FROM mivb
                WHERE `$lang` LIKE '$name'
            ";
    ...
    /**
     * get the station form the id.
     *
     * @todo replace the mysql_ functions with PDO,
     *       Eloquent or mysqli.
     *
     * @param $id
     * @param $lang
