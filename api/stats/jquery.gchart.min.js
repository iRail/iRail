...
(function ($) {
    ...
    $.extend(GChart.prototype, {
        ...
        seriesFromXml: function (f) {
            ...
            var j = false;
            try {
                f.find('series').each(function () {
                    var b = $(this);
                    var c = [];
                    b.find('point').each(function () {
                        var a = $(this);
                        var x = a.attr('x');
                        if (x != null) {
                            j = true;
        ...
        _generateChart: function (d) {
            ...
            for (var i = 0; i < d.series.length; i++) {
                ...
                if (e != 'lxy' || i % 2 == 0) {
                    ...
                    var n = ',';
                    $.each(($.isArray(d.series[i].color) ? d.series[i].color : [d.series[i].color]), function (i, v) {
        ...
        _updateChart: function (b, c) {
            ...
            if (c.usePost) {
                ...
                i.load(function () {
                    ...
                    if (c.onLoad) {
                        if (c.provideJSON) {
                            $.getJSON(c._src + '&chof=json&callback=?', function (a) {
