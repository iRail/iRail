...
class MobileWebOutput extends Page implements Output {
    ...
    public function printAll() {
        ...
        $this->page["location1"]= $this-> connections[0] -> getDepart() -> getStation() -> getLocationY() . " " . $this-> connections[0] -> getDepart() -> getStation() -> getLocationX();
        $this->page["location2"]= $this-> connections[0] -> getArrival() -> getStation() -> getLocationY() . " " . $this-> connections[0] -> getArrival() -> getStation() -> getLocationX();
