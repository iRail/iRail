...
<html>
  ...
  <body>
      ...
      <p>This is the unofficial API for the SNCB/NMBS in Belgium. If you want to implement train schedules in your application you are at the right place.</p>
      <h1>Usage</h1>
      ...
      <p><a href="http://project.irail.be/cgi-bin/trac.fcgi/wiki/Contributors">and others</a></p>
      <h1>Bugs</h1>
      ...
      <p>On the other hand if you noticed a flaw, something that doesn't work, something that might be important, ... feel free to report an issue at <a href="http://project.irail.be">the project iRail site</a></p>
