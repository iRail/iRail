...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('composition_unit', function (Blueprint $table) {
            ...
            $table->boolean('has_toilet')->nullable(false)->default(false)->comment('Whether a toilet is available');
            $table->boolean('has_prm_toilet')->nullable(false)->default(false)->comment('Whether a toilet accessible for passengers with reduced mobility is available');
            $table->boolean('has_airco')->nullable(false)->default(false)->comment('Whether air conditioning is available');
            $table->boolean('has_bike_section')->nullable(false)->default(false)->comment('Whether a section for bikes is present');
            $table->boolean('has_prm_section')->nullable(false)->default(false)->comment('Whether a section for passengers with reduced mobility is present');
