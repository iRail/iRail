...
class ConnectionsDatasource
{
    ...
    private static function requestHafasXml(
        ...
        if (str_starts_with($timeSel, 'dep')) {
            $timeSel = 0;
        } else {
            $timeSel = 1;
        }
